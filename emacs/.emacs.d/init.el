...
(custom-set-variables
 ...
 '(ghc-core-program-args
   '("-O2 -ddump-simpl -XNamedFieldPuns -XTypeSynonymInstances -XFlexibleInstances -XLambdaCase -XMultiParamTypeClasses"))
 '(hl-sexp-background-color "#efebe9")
 '(line-spacing 0.2)
 '(linum-format " %5i ")
 '(package-selected-packages
   '(mips-mode nim-mode transient magit slime-mode slime lua-mode racer flycheck-rust cargo lsp-mode ht gnu-elpa-keyring-update haskell-mode fira-code-mode popup-kill-ring diminish kaolin-themes tangotango-theme naysayer-theme poet-theme company dashboard sudo-edit hungry-delete rainbow-mode rainbow avy smex ido-vertical-mode ido-vertical-mod org-bullets beacon molokai-theme use-package))
