...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (popup-kill-ring diminish kaolin-themes tangotango-theme naysayer-theme poet-theme company dashboard sudo-edit hungry-delete rainbow-mode rainbow avy smex ido-vertical-mode ido-vertical-mod org-bullets beacon molokai-theme use-package)))
